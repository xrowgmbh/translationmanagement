...
{set-block scope=root variable=subject}{'[%sitename] Translation collaboration %objectname has been approved for publishing'
                                        |i18n( "extension/tm",,
                                               hash( '%sitename', ezini( "SiteSettings", "SiteURL" ),
                                                     '%objectname', concat( '#',$collaboration_item.id )|wash ) )}{/set-block}
{'This e-mail is to inform you that content objects have been published at %sitename. The translation process can viewed by using the URL below.'
 |i18n( 'extension/tm',,
        hash( '%sitename', ezini( "SiteSettings", "SiteURL" ),
